...
#print ' in a string
single_quat_str = "This is the string having single quatation (') in it."
print(single_quat_str, end='\n\n')
#------------------------------------------------------------

#another way of printing single quatation
single_quat_str = 'This is the another way of printing single quatation(\') in a string.'
print(single_quat_str, end='\n\n')
#------------------------------------------------------------

#another way of pringt single quation
...
#Count a perticualr string or CHAR
